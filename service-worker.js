...
const CACHE="Carnivorus Chef — Carnivore Companion";
const ASSETS=["./","./index.html","./manifest.webmanifest","./service-worker.js","./sprites/chef_placeholder_spritesheet.png"];
